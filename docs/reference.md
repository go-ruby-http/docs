...
The public API lives at the module root (`github.com/go-ruby-http/http`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `http`, while the surface follows
...
```go
import "github.com/go-ruby-http/http"
```
...
- **[pkg.go.dev/github.com/go-ruby-http/http](https://pkg.go.dev/github.com/go-ruby-http/http)**

The module's [README](https://github.com/go-ruby-http/http#readme) carries worked
