# go-ruby-http documentation

**Pure-Go, MRI-4.0.5-faithful Ruby http (no cgo)**

`go-ruby-http/http` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `http`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `http`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`http`](https://github.com/go-ruby-http/http) | the library — Ruby's `http` in pure Go |
| [`docs`](https://github.com/go-ruby-http/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-http.github.io`](https://github.com/go-ruby-http/go-ruby-http.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-http/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-http/http](https://github.com/go-ruby-http/http).
